...
function loggergen () {
$('#contentwrapper').append('<div id="logwrapper" class="uilvl1"><div class="container"><div class="heading2" id="logheader">Log</div><div id="logrecorder"></div></div></div>');
var thisenabled = "";
var thisdisabled = "";
if (settings.logger.enabled == 1){thisenabled = "checked"}else{thisdisabled = "checked"}
var settingselement = "logger";
$('#settingsgenmarker').after('<div class="container"><div class="heading2">Log</div><div id="loggersettings"></div></div>');
...
$('#navbuttons').append('<div class="navbutton" data-sort="6" data-dest="logwrapper">Log</div>');
$("#navbuttons").sortNav();
}
}
}
